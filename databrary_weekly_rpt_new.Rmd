...
<!-- # ```{r} -->
<!-- # ezknit(file = "databrary_weekly_rpt_new.Rmd", out_dir = paste0(getwd(),"weekly_reports/databrary_weekly_rpt_new_",Sys.Date(),".html", fig_dir = paste0(getwd(),"weekly_reports/databrary_weekly_rpt_new_",Sys.Date()) -->
<!-- # ``` -->
...
<!-- # #find.file(filename, dir = "", dirs = NULL) -->
