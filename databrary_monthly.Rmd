...
p <- updated_stats %>%
  ...
  ylab("Authorizations") +
  databrary_theme +
  scale_y_continuous(breaks = seq(0, round_any(max(updated_stats$count), 100), 100), expand = c(0,0)) +
  coord_cartesian(ylim = c(0, round_any(max(updated_stats$count), 100)))
...
#add adaptable ylim value TO DO
#coord_cartesian(ylim = c(0, round_any(max(updated_stats$count), 100)))
...
citations_plot <- 
  ...
  ylab("Citations") +
  databrary_theme +
  scale_y_continuous(breaks = seq(0, round_any(max(citations$count), 100)), 50), expand = c(0,0)) +
  coord_cartesian(ylim = c(0, round_any(max(citations$count), 100))))
