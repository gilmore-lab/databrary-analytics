...
Here we import the data file found in 'csv/citations-monthly.csv', include 'date', 'shared_volumes', 'unshared_volumes', 'databrary_citations', 'datavyu_citations' in dataframe (df2)
...
Here we import the data file found in 'csv/db-volumes-monthly.csv', include 'date', 'shared_volumes', 'unshared_volumes', 'databrary_citations', 'datavyu_citations' in dataframe (df2)
...
```{r p-citation-monthly-growth-plot, include=TRUE}
...
ggdraw(p2) + 
  draw_label("Unshared", colour = "#4CAE99", .9, .73) +
  draw_label("Shared", colour = "#ec7751", .7, .97)
