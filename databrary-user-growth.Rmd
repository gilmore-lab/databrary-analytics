...
# Using Points
p <- 
  ggplot(data=df.melt, aes(x = YearMonth, y = Count, color = Type, group = Type), xaxs = "i") +
  geom_point() + 
  geom_line(size=3) +
  theme_classic(base_size = 14) +                        #Axis Label Size
  scale_colour_manual(values=c("#f6ba93", "#91CFC1")) +  #Saturated Databrary Colors 
  ylab("Authorizations") +
  #xlab("Year") +
