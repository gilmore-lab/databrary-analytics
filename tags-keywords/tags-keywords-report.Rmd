...
To render the report, run `rmarkdown::render("tags-keywords-report.Rmd", params=list(db_login='<email@provider.com>')), substituting your Databrary login email for '<email@provider.com>'.
