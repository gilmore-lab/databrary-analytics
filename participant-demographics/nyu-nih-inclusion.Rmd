---
title: "NYU NIH Inclusion Enrollment Report"
author: "Rick Gilmore"
date: "`r Sys.Date()`"
...
This document explores produces an NIH-style inclusion enrollment report for a given set of volumes. Rick Gilmore created it for Justine Hoch and modified it for Christina Hospodar.
...
```{r}
# For KEA report on 2023-02-06 with info from christina.hospodar@nyu.edu
nyu_vols <- c(868,941,1020,1026,1379,1436,1448)
start_d <- "2022-02-18"
end_d <- "2023-02-25"
nyu_df <- get_nih_enrollment_data(nyu_vols, start_d, end_d)
```
