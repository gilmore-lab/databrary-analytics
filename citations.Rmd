...
ggdraw(citations_plot) + 
  draw_label("Datavyu, ", colour = color_teal, .8, .3) +
  draw_label(max(datavyu_cites), colour = color_teal, .88, .3) +
  draw_label(max(databrary_cites), colour = color_orange, .79, .7) +
  draw_label("Databrary, ", colour = color_orange, .7, .7)
```
